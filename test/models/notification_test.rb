...
class NotificationTest < ActiveSupport::TestCase
  ...
  test "join project request" do
    text = "aackermann has asked to join your project Alfa-Romeo.\n\nThat change will not take effect until you respond to the project challenge -4936889053604975600\n\n"
    n = Notification.new(nil, text, [], true)

    assert       n.join_project_request?
    assert_not   n.new_project_request?
    assert_equal "aackermann", n.sender
    assert_equal "Alfa-Romeo", n.project_id
    assert_equal "-4936889053604975600", n.challenge
  end

  test "new project request" do
    text = "abierce has created a new project Devils-Dictionary.\n\nThat project will not be active until someone approves it. You have the authority to do so.\n\n"
    n = Notification.new(nil, text, [], true)

    assert_not   n.join_project_request?
    assert       n.new_project_request?
    assert_equal "abierce", n.sender
